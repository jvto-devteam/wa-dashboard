...
export default function EmbeddedSignupPage() {
  ...
  const configId =
    process.env.NEXT_PUBLIC_FACEBOOK_LOGIN_BUSINESS_CONFIG_ID ||
    "1248176634152808";
  ...
  const launchWhatsAppSignup = () => {
    if (!window.FB) {
      alert(
        "Facebook SDK belum siap. Silakan tunggu sebentar atau refresh halaman.",
      );
      return;
    }
    ...
    try {
      window.FB.login(
        (response: any) => {
          if (response.authResponse) {
            ...
            alert(
              "Onboarding Berhasil! Silakan cek console log untuk mendapatkan kode.",
            );
          } else {
        ...
        },
        {
          ...
          extras: {
            featureType: "whatsapp_business_app_onboarding", // Ini opsional sebenarnya, tapi tidak masalah
            sessionInfoVersion: 3,
            // 👇 TAMBAHKAN BAGIAN INI 👇
            setup_options: ["allow_wa_business_app_coexistence"],
            // 👆 ---------------------- 👆
          },
        },
      );
      ...
      alert(
        "Terjadi kesalahan saat membuka popup. Pastikan FB SDK sudah terinisialisasi.",
      );
    }
  };
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-8">
          Hubungkan nomor WhatsApp Business Anda ke Cloud API tanpa kehilangan
          akses di aplikasi HP.
        </p>
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg text-left">
          ...
          <ul className="text-xs text-blue-700 space-y-2 list-disc pl-4">
            <li>
              Pastikan domain ini sudah terdaftar di{" "}
              <strong>Allowed Domains</strong> pada dashboard Meta App.
            </li>
            <li>
              Gunakan browser yang sama dengan akun Facebook pengelola bisnis
              Anda.
            </li>
            <li>
              Pilih opsi{" "}
              <strong>"Connect your existing WhatsApp Business App"</strong>{" "}
              saat diminta.
            </li>
          </ul>
        </div>
